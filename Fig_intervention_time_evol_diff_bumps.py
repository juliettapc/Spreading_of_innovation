...
### Actual evolution :
    ...
    filename1="../Results/weight_shifts/persuasion/Time_evolutions_Persuasion_training_alpha0.1_damping0.0_mutual_encourg0.0_threshold0.5_unif_distr_1000iter_alphaA_eq_alphaF_243_A_F_inferred_middle.dat"   # persuasion no interv
    file1=open(filename1,'r')


     
    
    filename2="../Results/weight_shifts/persuasion/Time_evolutions_Persuasion_alpha0.1_damping0.0_mutual_encourg0.0_threshold0.5_num_reseed_per_shift1_1000iter_intervention_start20_window"+str(window)+"_bump0.4_comparison_to_simu_without_interv.dat"
    file2=open(filename2,'r')  #persuasion interv bump=0.4
    


 
    filename4="../Results/weight_shifts/persuasion/Time_evolutions_Persuasion_alpha0.1_damping0.0_mutual_encourg0.0_threshold0.5_num_reseed_per_shift1_1000iter_intervention_start20_window"+str(window)+"_bump0.6_comparison_to_simu_without_interv.dat"
    ...
    for line in lista_lines:                   
            ...
            listX.append(int(items[0]))  # time  
            listY2.append(float(items[5]))  # num adopters (A+F) simu interv
    ...
    for line in lista_lines:                   
            ...
            listX.append(int(items[0]))  # time  
            listY3.append(float(items[5]))  # num adopters (A+F) simu interv
    ...
    filename="../Results/intervention/Fig_intervention_evolution_number_adopters_diff_bumps_window"+str(window)+".agr" 
