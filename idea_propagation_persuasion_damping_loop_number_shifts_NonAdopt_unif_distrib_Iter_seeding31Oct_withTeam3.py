...
# running time for the whole parameter space:  	437m40.302s
            ...
            for iter in range(Niter):
             ...
             #   file2 = open(output_file.split('.dat')[0]+"_indiv_iter"+str(iter)+".dat",'at')                
              ...
              ########################################################
                ...
                #print time_evol_number_adopters

# this two list must have the same lenght:           print len(list_t),len(time_evol_number_adopters)
