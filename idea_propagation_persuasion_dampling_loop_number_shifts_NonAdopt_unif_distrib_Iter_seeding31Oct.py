...
def main(graph_name):
    ...
    while alpha_F<= alpha_F_max:
            ...
            dir="../Results/"   
            output_file2=dir+"Final_number_Adopters_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_unif_distr_"+str(Niter)+"iter_2012_seed31Oct.dat"    
            ...
            output_file=dir+"Time_evolutions_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_unif_distr_"+str(Niter)+"iter_2012_seed31Oct.dat"        
            ...
            print >> file2,   numpy.mean(list_final_number_Adopters_fixed_num_shift),alpha_F,damping,mutual_encouragement
            file2.close()
