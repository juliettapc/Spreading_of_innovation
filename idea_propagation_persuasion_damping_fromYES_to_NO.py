...
def main(graph_name):
    ...
    alpha_F_max=0.21
    delta_alpha_F=0.05
    damping=0.0  #its harder to go back from YES to NO again. =1 means no effect, =0.5 half the movement from Y->N than the other way around
    ...
    while alpha_F<= alpha_F_max:
        ...
        dir="../Results/"   
        output_file=dir+"Time_evolutions_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+".dat"    
