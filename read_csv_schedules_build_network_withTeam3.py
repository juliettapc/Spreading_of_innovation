...
#######################
   ...
   #adding nodes for the Attendings and Fellows:   
        ...
        if len(row[0]) >0:
           ...
           # print date2
            ...
            if len(A1)==0 or len(A2)==0:
                print "waiiiiiiiit something just happened!"
                print row
                raw_input()
    ...
    # what about the order???   does it need to be different for T1 and T2??
                    ...
                    print "link:", A1,label_date1_T1
                    print "link:", F2,label_date1_T2
                    print "link:", A2,label_date1_T2
...
##################################
    ...
    nx.write_gml(G,"../Results/Doctors_shifts_network_withT3.gml") #  you run the code from  Idea-Spread-Hospital/Code/.
