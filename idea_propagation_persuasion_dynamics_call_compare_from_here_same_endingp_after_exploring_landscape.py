...
#../Results/network_final_schedule_withTeam3/Time_evolutions_Persuasion_alpha0.2_damping0.0_mutual_encourg0.7_threshold0.4_unif_distr_50iter_2012_seed31Oct_finalnetwork.dat
   ...
   threshold_min=0.50  # larger than, to be an Adopte
   threshold_max=0.51
   delta_threshold=0.1
...
#                file4 = open(output_file.split('.dat')[0]+"_indiv_iter"+str(iter)+".dat",'wt')       
 #               file4.close()
   ...
   compare_real_evol_vs_simus_to_be_called.pick_minimum_same_end(dict_filenames_tot_distance,"Persuasion_land",all_team,Niter,None)  #las argument, cutting day (it doesnt apply)
