    ...
    while prob_infection<= prob_max:
     ...
     #   list_abs_dist_at_cutting_day=[]
       ...
       # raw_input()
        ...
        histogram_filename="../Results/weight_shifts/histogr_raw_distances_ending_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle_real_ic.dat"
      ...
      #  histogram_filename2="../Results/weight_shifts/histogr_sum_dist_traject_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle.dat"
       ...
       # histograma_bines_gral.histograma_bins(list_dist_fixed_parameters,Nbins,histogram_filename2)
        ...
        histogram_filename3="../Results/weight_shifts/histogr_sum_dist_testing_segment_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle_real_ic.dat"
        ...
        histogram_filename4="../Results/weight_shifts/histogr_abs_dist_point_by_point_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle_real_ic.dat"
        
        histograma_gral_negv_posit.histograma(list_abs_dist_point_by_point_indiv_simus_to_actual,histogram_filename4)
        
        
        
        histogram_filename5="../Results/weight_shifts/histogr_dist_point_by_point_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle_real_ic.dat"
        ...
        output_file10="../Results/weight_shifts/Summary_results_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle_real_ic.dat"
