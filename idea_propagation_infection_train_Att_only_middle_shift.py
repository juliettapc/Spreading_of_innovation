...
#../Results/network_final_schedule_withTeam3/infection/Average_time_evolution_Infection_p0.9_Immune0.5_1000iter_2012.dat
   ...
   if print_landscape=="YES":
      output_file3="../Results/weight_shifts/Landscape_parameters_infection_train_"+str(Niter)+"iter_Att_only_middle_day"+str(cutting_day)+".dat"  
   ...
   while prob_Immune<= prob_Immune_max:
      ...
      while prob_infection<= prob_max:
        ...
        output_file2=dir+"Average_time_evolution_Infection_training_p"+str(prob_infection)+"_"+"Immune"+str(prob_Immune)+"_"+str(Niter)+"iter_2012_avg_ic_day"+str(cutting_day)+"_Att_only_middle.dat" 
     #   file2 = open(output_file2,'wt')                                          I DONT NEED TO WRITE IT, COS I WILL USE THE WHOLE FILE FROM THE WHOLE FIT, WITH THE PARAMETER VALUES THAT THE TESTING-UP-TODAY-125 TELLS ME
      #  file2.close()
        ...
        output_file4=dir+"List_adopters_fellows_descending_frequency_Infection_training_p"+str(prob_infection)+"_"+"Immune"+str(prob_Immune)+"_"+str(Niter)+"iter_2012_avg_ic_day"+str(cutting_day)+"_Att_only_middle.dat" 
   ...
   if print_training_evol== "NO":  #if i am exploring the whole space
      ...
      string_name="infection_training_"+fixed_param+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle.dat"    # for the "Results" file with the sorted list of files
...
# it returns a list of tuples like this :  ('../Results/network_final_schedule_withTeam3_local/infection/Average_time_evolution_Infection_training_p0.7_Immune0.0_2iter_2012.dat', [2540.0, 208.0, 1.0])  the best set of parameters  being the fist one of the elements in the list.
   ...
   #  i already know the optimum, now i run the dynamics with those values, starting from the average state on the cutting point, and test: 
      ...
      output_file10="../Results/weight_shifts/Summary_results_training_segment_infection_p"+str(prob_infection)+"_"+"Immune"+str(prob_Immune)+"_"+str(Niter)+"iter_avg_ic_day"+str(cutting_day)+"_Att_only_middle.dat"           
