...
def main(graph_name):
   ...
   output_file3="../Results/weight_shifts/Landscape_parameters_infection_memory_fixed_dose_thr_"+str(Niter)+"iter.dat" 
      ...
      while prob_infection<= prob_max:
         ...
         while infect_threshold <= infect_threshold_max:
            ...
            while dose <= dose_max:
               ...
               output_file2=dir+"Average_time_evolution_Infection_memory_p"+str(prob_infection)+"_"+"Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter.dat"
