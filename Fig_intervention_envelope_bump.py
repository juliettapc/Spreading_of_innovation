...
### Actual evolution :
    ...
    list_yLegends=["","","empirical","avg simulation with intervention","avg simulation"]
    xTitle="Days" 
    yTitle="Number of adopters"

    filename="../Results/weight_shifts/figures_pygrace/Fig_intervention_envelope_window"+str(window)+"_bump"+str(bump)+".agr" 
  

    colors = [1,3,1,4,10]  # for each series
