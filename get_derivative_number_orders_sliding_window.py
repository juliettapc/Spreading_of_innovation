...
def main():
    ...
    ############ output files
    output_file=filename_actual_evol.split(".")[0]+"_derivative.dat"
    file = open(output_file,'wt')    
  

    output_file2=filename_actual_evol.split(".")[0]+"_derivative_sliding_window"+str(time_window)+".dat"
