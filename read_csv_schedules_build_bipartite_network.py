              ...
              #labels for the nodes:
                ...
                if "," in att2:    # in some fields we have: att1 mm/dd-dd, att2 mm/dd-dd
                  ...
                  #dates:                Week:
                    ...
                    end_week= row[5] # always CLOSED interval to describe the shifts
...
##################################
    ...
    nx.write_gml(G,"../Results/Doctors_Shifts_network.gml") #  you run the code from  Idea-Spread-Hospital/Code
    ...
    nx.write_gml(G,"../Results/Doctors_Shifts_network_without_times.gml") #  you run the code from  Idea-Spread-Hospital/Code
