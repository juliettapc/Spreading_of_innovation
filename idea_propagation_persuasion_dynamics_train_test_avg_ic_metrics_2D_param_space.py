...
def main(graph_name):
   ...
   output_file3="../Results/after_exploring_landscape/Landscape_parameters_persuasion_train_test_"+str(fixed_parameters)+"_"+str(Niter_training)+"iter.dat" 
...
#../Results/network_final_schedule_withTeam3/Time_evolutions_Persuasion_alpha0.2_damping0.0_mutual_encourg0.7_threshold0.4_unif_distr_50iter_2012_seed31Oct_finalnetwork.dat
   ...
   alpha_F_min=0.15   # alpha=0: nobody changes their mind
   alpha_F_max=0.35 #AVOID 1.0 OR THE DYNAMICS GETS TOTALLY STUCK AND CANT PREDICT SHIT!
   delta_alpha_F=0.01
   ...
   max_mutual_encouragement=0.51
   delta_mutual_encouragement=0.1
   
   
   threshold_min=0.5  # larger than, to be an Adopte
   threshold_max=0.51    #AVOID 1.0 OR THE DYNAMICS GETS TOTALLY STUCK AND CANT PREDICT SHIT!
   delta_threshold=0.1
      ...
      while alpha_F<= alpha_F_max:            # i explore all the parameter space, and create a file per each set of values
        ...
        while  mutual_encouragement <= max_mutual_encouragement:
          ...
          while   damping <= max_damping:
            ...
            dir="../Results/after_exploring_landscape/"  
   ...
   list_order_dict=  compare_real_evol_vs_simus_to_be_called.pick_minimum_same_end(dict_filenames_tot_distance,"Persuasion_training_land",all_team,Niter_training,cutting_day)
...
#list_sorted_dict=[(u'Weiss', 5.0), (u'Wunderink', 5.0), (u'Keller', 4.0), (u'Go', 3.0), (u'Cuttica', 3.0), (u'Rosario', 2.0), (u'Radigan', 2.0), (u'Smith', 2.0), (u'RosenbergN', 2.0), (u'Gillespie', 1.0), (u'Osher', 1.0), (u'Mutlu', 1.0), (u'Dematte', 1.0), (u'Hawkins', 1.0), (u'Gates', 1.0)]
   ...
   histograma_gral_negv_posit.histograma(list_dist_at_ending_point_fixed_parameters,"../Results/after_exploring_landscape/histogr_raw_distances_ending_test_train_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter_training)+"iter_avg_ic_day"+str(cutting_day)+".dat" ) 




   output_file8="../Results/after_exploring_landscape/List_tot_distances_training_segment_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter_training)+"iter_avg_ic_day"+str(cutting_day)+".dat"       
   ...
   output_file9="../Results/after_exploring_landscape/List_distances_ending_training_segment_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter_training)+"iter_avg_ic_day"+str(cutting_day)+".dat"         
   ...
   output_file10="../Results/after_exploring_landscape/Summary_results_train_test_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter_training)+"iter_avg_ic_day"+str(cutting_day)+".dat"         
