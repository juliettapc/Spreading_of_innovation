   ...
   while prob_Immune<= prob_Immune_max:
    ...
    while prob_infection<= prob_max:
      ...
      while dose <= dose_max:
        ...
        output_file2=dir+"Average_time_evolution_Infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_FIXED_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"
...
#  print "avg simu number Fellow adopters:",num_simu_Fellow_adopters_cutting_day,int( round(num_simu_Fellow_adopters_cutting_day))
     ...
     #   list_abs_dist_at_cutting_day=[]
       ...
       # raw_input()
        ...
        histogram_filename="../Results/weight_shifts/histogr_raw_distances_ending_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"
        ...
        histogram_filename3="../Results/weight_shifts/histogr_sum_dist_testing_segment_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"
        ...
        histogram_filename4="../Results/weight_shifts/histogr_abs_dist_point_by_point_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"
        
        histograma_gral_negv_posit.histograma(list_abs_dist_point_by_point_indiv_simus_to_actual,histogram_filename4)
        
        
        
        histogram_filename5="../Results/weight_shifts/histogr_dist_point_by_point_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"
        ...
        output_file10="../Results/weight_shifts/Summary_results_infection_memory_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"
