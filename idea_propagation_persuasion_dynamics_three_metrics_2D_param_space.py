...
def main(graph_name):
   ...
   delta_end=3  # >= than + or -  dr difference at the end of the evolution  I WANT THEM ALL FOR NOW
   ...
   fixed_parameters="mutual_encoug0.5_threshold0.5"      #"threshold0.5_damping0.0"   # for the Landscape text file CHANGE PARAMETERS ACCORDINGLY!!!


   output_file3="../Results/after_exploring_landscape/Landscape_parameters_persuasion_"+str(fixed_parameters)+"_"+str(Niter)+"iter.dat" 
...
#../Results/network_final_schedule_withTeam3/Time_evolutions_Persuasion_alpha0.2_damping0.0_mutual_encourg0.7_threshold0.4_unif_distr_50iter_2012_seed31Oct_finalnetwork.dat
   ...
   min_mutual_encouragement=0.5  # when two Adopters meet, they convince each other even more
   max_mutual_encouragement=0.51
   delta_mutual_encouragement=0.05
   
   
   threshold_min=0.5  # larger than, to be an Adopter
   threshold_max=0.51
   delta_threshold=0.05


  #   "mutual_encoug0.5_damping0.0"
 ...
 #               file4.close()
              ##########################################
               ...
               # the dynamics starts:                 
                ...
                list_abs_dist_at_ending_point_fixed_parameters.append( abs(time_evol_number_adopters[-1]-list_actual_evol[-1]) )
            ...
            print >> file3, alpha_F, damping, mutual_encouragement, threshold,numpy.mean(list_abs_dist_at_ending_point_fixed_parameters), numpy.mean(list_dist_fixed_parameters),    numpy.mean(list_final_num_adopt),numpy.std(list_final_num_adopt),    numpy.std(list_final_num_adopt)/numpy.mean(list_final_num_adopt)
            file3.close()
   ...
   compare_real_evol_vs_simus_to_be_called.pick_minimum_same_end(dict_filenames_tot_distance,"Persuasion_land",all_team,Niter,None)  #last argument, cutting day (doesnt apply)
