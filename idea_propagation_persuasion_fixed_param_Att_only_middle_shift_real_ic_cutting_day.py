      ...
      while alpha_F<= alpha_F_max:            # i explore all the parameter space, and create a file per each set of valuesllkl
        ...
        while  mutual_encouragement <= max_mutual_encouragement:
          ...
          while   damping <= max_damping:
            ...
            output_file=dir+"Time_evol_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter)+"iter_"+str(cutting_day)+"_Att_only_middle_real_ic.dat"     
...
#../Results/weight_shifts/infection/List_adopters_fellows_descending_frequency_Infection_training_p0.7_Immune0.7_1000iter_2012_avg_ic_day150_Att_only_middle.dat

#../Results/weight_shifts/infection/List_adopters_fellows_descending_frequency_Infection_memory_training_p0.5_Immune0.0_FIXED_threshold1.0_dose0.2_1000iter_day75_Att_only_middle.dat
...
#    print "one-day weekend", G.node[n]['label'],G.node[n]['shift_length']
            ...
            histogram_filename="../Results/weight_shifts/histogr_raw_distances_ending_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"         
            ...
            histogram_filename3="../Results/weight_shifts/histogr_sum_dist_testing_segment_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"          
            ...
            histogram_filename4="../Results/weight_shifts/histogr_abs_dist_point_by_point_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"          
            ...
            histogram_filename5="../Results/weight_shifts/histogr_dist_point_by_point_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"_Att_only_middle_real_ic.dat"          
            ...
            output_file10="../Results/weight_shifts/Summary_results_persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_threshold"+str(threshold)+"_"+str(Niter)+"iter_day"+str(cutting_day)+"__Att_only_middle_real_ic.dat"                   
