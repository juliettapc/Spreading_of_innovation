...
#####  Models :
    ...
    filename_model_I_A_train_test="../Results/weight_shifts/Average_time_evolution_Infection_train_test_p0.8_Immune0.6_1000iter_2012.dat"     
    
    
    filename_model_I_B_mem_train_test="../Results/weight_shifts/Average_time_evolution_Infection_memory_distrib_train_test_p0.8_Immune0.6_1000iter_2012.dat"
    
    
    filename_model_I_C_mem_train_test="../Results/weight_shifts/Average_time_evolution_Infection_memory_p0.7_Immune0.5_threshold0.1_dose0.1_100iter.dat"
  




    list_files=[filename_model_I_A_train_test,filename_model_I_B_mem_train_test,filename_model_I_C_mem_train_test]
    ...
    list_yLegends=["","Experimental","Infection Model A","Infection Model B","Infection Model C",""]
    yTitle="Number of Adopters"
    filename="../Results/weight_shifts/figures_pygrace/Fig3a_multiple_infection.agr"

    colors = [0,1,11,2,13]  # for each series
    xTitle="Days"
...
# filename order:  background,  empirical, filename_model_I_train,filename_model_I_test,filename_model_I_mem_train,filename_model_I_mem_test,filename_model_I_mem_distrib_train,filename_model_I_mem_distrib_test,filename_model_P_train,filename_model_P_test
 ...
 # zip([a,b,c],[1,2,3]) returns  [(a,1),(b,2),(c,3)]
        ...
        if cont==0:          # the fist dataset is just fake data for the background
           ...
           # if cont==3 or cont==5 or cont==7 or cont==9:
