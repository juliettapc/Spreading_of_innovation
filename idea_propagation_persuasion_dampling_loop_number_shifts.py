...
def main(graph_name):
    ...
    while alpha_F<= alpha_F_max:
        ...
        dir="../Results/"   
        output_file2=dir+"Final_number_Adopters_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_2012.dat"    
        ...
        for num_initial_shifts in range(tot_num_shifts):            
            ...
            dir="../Results/"   
            output_file=dir+"Time_evolutions_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_num_shifts"+str(num_initial_shifts)+"_mutual_encourg"+str(mutual_encouragement)+"_2012.dat"    
