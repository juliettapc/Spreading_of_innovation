...
### Actual evolution :
    ...
    for line in lista_lines:                   
            ...
            listY1.append(float(items[14]))  # num interventions per iter
  ...
  #----
    ...
    for line in lista_lines:                   
            ...
            listX.append(float(items[1]))  # bump/threshold
            listY2.append(float(items[14]))  # num interventions per iter
  ...
  #----
    ...
    for line in lista_lines:                   
            ...
            listX.append(float(items[1]))  # bump/threshold
            listY3.append(float(items[14]))  # num interventions per iter
  ...
  #----
    ...
    for line in lista_lines:                   
            ...
            listX.append(float(items[1]))  # bump/threshold
            listY4.append(float(items[14]))  # num interventions per iter
  ...
  #----
    ...
    xTitle="Prompt size" 
    yTitle="Number successful of interventions"

    filename="../Results/intervention/Fig_intervention_number_successful_interventions_vs_bump_diff_w.agr" 
