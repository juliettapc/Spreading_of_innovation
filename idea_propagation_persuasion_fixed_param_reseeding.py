...
def main(graph_name):
   ...
   bump=0.001  # for the doctors that are re-seeded  
...
##################################################################
   ...
   print   "tot # interventions",float(tot_number_interventions)/float(Niter),"tot # successful interventions",float(tot_number_successful_interventions)/float(Niter)
