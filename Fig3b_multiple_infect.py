...
#####  Models :
    ...
    filename_model_I="../Results/weight_shifts/histogr_raw_distances_ending_test_train_infection_p0.8_Immune0.6_1000iter_day125.dat"
    filename_model_I2="../Results/weight_shifts/histogr_raw_distances_ending_test_train_infection_memory_distrib_p0.8_Immune0.6_1000iter_day125.dat"
    filename_model_I3="../Results/weight_shifts/histogr_raw_distances_ending_test_train_infection_memory_distrib_p0.7_Immune0.5_threshold0.1_dose0.1_1000iter_day125.dat"
    ...
    list_files=[filename_model_I,filename_model_I2,filename_model_I3]
    ...
    list_yLegends=["Infection Model A","Infection Model B","Infection Model C"]
    
    filename="../Results/weight_shifts/figures_pygrace/Fig3b_multiple_infect.agr"
    
    colors = [2,11,13]  # for each series
