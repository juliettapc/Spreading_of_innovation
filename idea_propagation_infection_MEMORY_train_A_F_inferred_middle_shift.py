...
def main(graph_name):
   ...
   print_landscape="YES"#NO"     #YES"  # for the whole exploration
...
#######
   ...
   dose_min=0.20              #infect_threshold_min
   ...
   if print_landscape=="YES":
      output_file3="../Results/weight_shifts/Landscape_parameters_infection_memory_train_"+fixed_param+"_"+str(Niter_training)+"iter_A_F_inferred_middle_day"+str(cutting_day)+".dat"  
   ...
   while prob_Immune<= prob_Immune_max:
    ...
    while prob_infection<= prob_max:
      ...
      while dose <= dose_max:
        ...
        output_file2=dir+"Average_time_evolution_Infection_memory_training_p"+str(prob_infection)+"_Immune"+str(prob_Immune)+"_FIXED_threshold"+str(infect_threshold)+"_dose"+str(dose)+"_"+str(Niter_training)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle.dat"
   ...
   if print_training_evol== "NO":  #if i am exploring the whole space
      ...
      string_name="infection_memory_training_"+fixed_param+str(Niter_training)+"iter_day"+str(cutting_day)+"_A_F_inferred_middle.dat"   # for the "Results" file with the sorted list of files
