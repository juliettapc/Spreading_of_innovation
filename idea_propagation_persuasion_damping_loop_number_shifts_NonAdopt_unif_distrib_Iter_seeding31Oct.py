...
def main(graph_name):
    ...
    while alpha_F<= alpha_F_max:
            ...
            dir="../Results/"   
            output_file2=dir+"Final_number_Adopters_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_unif_distr_"+str(Niter)+"iter_2012_seed31Oct_finalnetwork.dat"    
            ...
            output_file=dir+"Time_evolutions_Persuasion_alpha"+str(alpha_F)+"_damping"+str(damping)+"_mutual_encourg"+str(mutual_encouragement)+"_unif_distr_"+str(Niter)+"iter_2012_seed31Oct_finalnetwork.dat"        
...
def set_ic(G,threshold):
        ...
        for n in G.nodes():              
            if G.node[n]['type']=="shift":
                if n not in list_s:
                    list_s.append(n)                        
                if "10/31/11" in G.node[n]['label']: # actual seeding date                          
